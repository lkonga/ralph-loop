...
const CANONICAL_PATH = resolve(__dirname, '../../vscode-config-files/agents/wave-context-grounder.agent.md');
const SYMLINK_PATH = resolve(__dirname, '../agents/wave-context-grounder.agent.md');

describe('Wave Context Grounder Agent — Task 25', () => {
	it('should exist at vscode-config-files/agents/wave-context-grounder.agent.md', () => {
