...
const CANONICAL_PATH = resolve(__dirname, '../../vscode-config-files/agents.source/wave-prd-generator.agent.md');

describe('Wave PRD Generator Agent — Task 27', () => {
	it('should exist at vscode-config-files/agents.source/wave-prd-generator.agent.md', () => {
